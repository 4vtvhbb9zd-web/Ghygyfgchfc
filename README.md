# Ghygyfgchfc
اختبار تفاعلي شامل في الكيمياء - درس المول

إليك الكود المحدث الذي يتضمن:

1. إدخال اسم الطالب ورقم الشعبة في البداية
2. منع تخطي السؤال دون حله
3. منع الرجوع للخلف
4. عرض النتائج مع اسم الطالب ورقم الشعبة
...
1. إدخال بيانات الطالب في البداية:
   · حقل لإدخال اسم الطالب
   · حقل لإدخال رقم الشعبة
   · التحقق من إدخال البيانات قبل بدء الاختبار
2. منع تخطي الأسئلة:
   · زر "التالي" معطل حتى يتم الإجابة على السؤال الحالي
   · لا يمكن الانتقال للسؤال التالي دون اختيار إجابة
3. منع الرجوع للخلف:
   · زر "السابق" معطل تماماً
   · لا يمكن العودة للأسئلة السابقة
4. عرض بيانات الطالب في النتائج:
   · عرض اسم الطالب ورقم الشعبة في صفحة النتائج
   · عرض التقدير والنسبة المئوية
5. تحسينات واجهة المستخدم:
   · تصميم جميل لصفحة إدخال البيانات
   · عرض بيانات الطالب أثناء الاختبار
   · تنسيق متسق للألوان والخطوط

يمكنك نسخ هذا الكود وحفظه في ملف HTML وفتحه في أي متصفح. سيعمل الاختبار بشكل كامل مع جميع الميزات المطلوبة.
